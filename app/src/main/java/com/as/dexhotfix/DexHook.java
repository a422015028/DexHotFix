...
public class DexHook implements IXposedHookLoadPackage {
    ...
    private static String TAG = "dexhotfix";


    private static String PackageName = "org.swiftapps.swiftbackup";

    private Context mContext;
    public  static   ClassLoader mLoader;

    private static String ClassPath = "org.swiftapps.swiftbackup.intro.IntroActivity";
